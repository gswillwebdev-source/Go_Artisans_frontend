...
export default function FollowStats({ followerCount = 0, followingCount = 0, isOwnProfile = false }) {
  ...
  return (
    <div className="flex flex-wrap gap-5 py-5 border-b border-slate-200">
      <div className="min-w-[110px] flex flex-col items-center rounded-xl bg-blue-50/80 px-4 py-3 border border-blue-100">
      ...
      <div className="min-w-[110px] flex flex-col items-center rounded-xl bg-emerald-50/80 px-4 py-3 border border-emerald-100">
