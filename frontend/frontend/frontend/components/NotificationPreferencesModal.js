                ...
                {preferences && (
                    <>
                        ...
                        <div className="rounded-2xl border border-blue-200 bg-blue-50/30 p-4 space-y-3">
                            <div>
                                <h3 className="text-sm font-semibold text-slate-900">💳 Billing & Subscription</h3>
                                <p className="text-xs text-slate-600 mt-1">Manage your plan, view billing details, and upgrade or cancel your subscription.</p>
                            </div>
                            <button
                                type="button"
                                onClick={() => { onClose(); router.push('/subscription?tab=billing') }}
                                className="w-full rounded-xl bg-blue-600 hover:bg-blue-700 px-4 py-2.5 text-sm font-semibold text-white transition shadow-sm"
                            >
