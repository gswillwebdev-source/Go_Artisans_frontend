...
export default function ChooseRolePage() {
    ...
    const chooseRole = async (selectedRole) => {
        ...
        try {
            ...
            // Record pending referral (if the user signed up via a referral link)
            try {
                const pendingCode = typeof window !== 'undefined' && localStorage.getItem('pendingReferralCode')
                if (pendingCode) {
                ...
                // Non-critical — don't block role assignment
            }
