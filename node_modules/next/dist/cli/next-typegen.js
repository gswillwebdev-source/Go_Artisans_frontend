...
const nextTypegen = async (_options, directory)=>{
    ...
    const routeTypesFilePath = (0, _path.join)(distDir, 'types', 'route-types.d.ts');
    ...
    const entryFilePath = (0, _path.join)(baseDir, nextConfig.distDirRoot, 'types', 'routes.d.ts');
    const actualTypesDir = (0, _path.join)(distDir, 'types');
