...
class TurbopackManifestLoader {
    constructor({ distDir, buildId, encryptionKey, dev, deploymentId }){
    ...
    writeClientBuildManifest(entrypoints, devRewrites, productionRewrites) {
        ...
        if (this.deploymentId && !this.dev) {
            ...
            buildManifestPath = (0, _path.join)(_constants.CLIENT_STATIC_FILES_PATH, '_buildManifest.js');
            ssgManifestPath = (0, _path.join)(_constants.CLIENT_STATIC_FILES_PATH, '_ssgManifest.js');
        } else {
            buildManifestPath = (0, _path.join)(_constants.CLIENT_STATIC_FILES_PATH, this.buildId, '_buildManifest.js');
            ssgManifestPath = (0, _path.join)(_constants.CLIENT_STATIC_FILES_PATH, this.buildId, '_ssgManifest.js');
        }
   ...
   */ loadMiddlewareManifest(pageName, type) {
    ...
    writeMiddlewareManifest() {
        let clientMiddlewareManifestPath = this.deploymentId && !this.dev ? (0, _path.join)(_constants.CLIENT_STATIC_FILES_PATH, _constants.TURBOPACK_CLIENT_MIDDLEWARE_MANIFEST) : (0, _path.join)(_constants.CLIENT_STATIC_FILES_PATH, this.buildId, _constants.TURBOPACK_CLIENT_MIDDLEWARE_MANIFEST);
