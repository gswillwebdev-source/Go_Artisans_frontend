...
import { createRouteTypesManifest, writeRouteTypesManifest, writeValidatorFile, writeRouteTypesEntryFile } from '../server/lib/router-utils/route-types-utils';
...
async function writeClientSsgManifest(prerenderManifest, { buildId, distDir, locales, deploymentId }) {
    ...
    let ssgManifestPath = deploymentId ? path.join(CLIENT_STATIC_FILES_PATH, '_ssgManifest.js') : path.join(CLIENT_STATIC_FILES_PATH, buildId, '_ssgManifest.js');
    ...
    try {
        ...
        await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            await nextBuildSpan.traceChild('generate-route-types').traceAsyncFn(async ()=>{
                ...
                const entryFilePath = path.join(dir, config.distDirRoot, 'types', 'routes.d.ts');
            ...
            await recordFrameworkVersion("16.2.0-canary.53");
            ...
            if (middlewareFile) {
                ...
                if (staticInfo.runtime === 'nodejs' || isProxyFile(page)) {
                    ...
                    if (bundler === Bundler.Turbopack) {
                        ...
                        let clientMiddlewareManifestPath = config.deploymentId ? path.join(CLIENT_STATIC_FILES_PATH, TURBOPACK_CLIENT_MIDDLEWARE_MANIFEST) : path.join(CLIENT_STATIC_FILES_PATH, buildId, TURBOPACK_CLIENT_MIDDLEWARE_MANIFEST);
