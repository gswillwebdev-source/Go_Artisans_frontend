...
import { createRouteTypesManifest, writeRouteTypesManifest, writeValidatorFile, writeRouteTypesEntryFile } from './route-types-utils';
...
async function startWatcher(opts) {
    ...
    }, path.join(distTypesDir, 'route-types.d.ts'), opts.nextConfig);
    // Write the entry file at {distDirRoot}/types/routes.d.ts for initial state
    const initialEntryFilePath = path.join(opts.dir, opts.nextConfig.distDirRoot, 'types', 'routes.d.ts');
         ...
         */ if (/[\\\\/]_middleware$/.test(pageName)) {
            ...
            try {
                ...
                if (enabledTypeScript) {
                    ...
                    const entryFilePath = path.join(opts.dir, opts.nextConfig.distDirRoot, 'types', 'routes.d.ts');
