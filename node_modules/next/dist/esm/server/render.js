...
export async function renderToHTMLImpl(req, res, pathname, query, renderOpts, extra, sharedContext, renderContext) {
    ...
    const metadata = {};
    metadata.assetQueryString = process.env.__NEXT_DEV_SERVER && renderOpts.assetQueryString || '';
    ...
    if (isSSG && !isFallback) {
        ...
        if ((process.env.__NEXT_DEV_SERVER || isBuildTimeSSG) && !metadata.isNotFound && !isSerializableProps(pathname, 'getStaticProps', data.props)) {
    ...
    if (getServerSideProps && !isFallback) {
        ...
        if ((process.env.__NEXT_DEV_SERVER || isBuildTimeSSG) && !isSerializableProps(pathname, 'getServerSideProps', data.props)) {
            // this fn should throw an error instead of ever returning `false`
