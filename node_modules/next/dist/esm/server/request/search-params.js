...
export function createServerSearchParamsForMetadata(underlyingSearchParams, workStore) {
    const metadataVaryParamsAccumulator = getMetadataVaryParamsAccumulator();
    return createServerSearchParamsForServerPage(underlyingSearchParams, workStore, metadataVaryParamsAccumulator, metadataIsRuntimePrefetchable);
}
export function createServerSearchParamsForServerPage(underlyingSearchParams, workStore, varyParamsAccumulator, isRuntimePrefetchable) {
    const workUnitStore = workUnitAsyncStorage.getStore();
    if (workUnitStore) {
        switch(workUnitStore.type){
            case 'prerender':
