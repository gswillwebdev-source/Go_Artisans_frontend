...
export function trackThrownErrorInNavigation(dynamicValidation, error, componentStack) {
...
export function getNavigationDisallowedDynamicReasons(workStore, prelude, dynamicValidation, boundaryState) {
    ...
    if (boundaryState.renderedIds.size < boundaryState.expectedIds.size) {
        ...
        if (thrownErrorsOutsideBoundary.length === 0) {
            return [
                Object.defineProperty(new Error(`Route "${workStore.route}": Could not validate \`unstable_instant\` because the target segment was prevented from rendering for an unknown reason.`), "__NEXT_ERROR_CODE", {
                    value: "E1056",
                    enumerable: false,
                    configurable: true
                })
            ...
            return [
                Object.defineProperty(new Error(`Route "${workStore.route}": Could not validate \`unstable_instant\` because the target segment was prevented from rendering, likely due to the following error.`), "__NEXT_ERROR_CODE", {
                    value: "E1059",
                    enumerable: false,
                    configurable: true
                }),
            ...
            return [
                Object.defineProperty(new Error(`Route "${workStore.route}": Could not validate \`unstable_instant\` because the target segment was prevented from rendering, likely due to one of the following errors.`), "__NEXT_ERROR_CODE", {
                    value: "E1057",
                    enumerable: false,
                    configurable: true
                }),
