...
async function createFlightRouterStateFromLoaderTreeImpl(loaderTree, getDynamicParamFromSegment, searchParams, didFindRootLayout) {
    ...
    for(const parallelRouteKey in parallelRoutes){
        const child = await createFlightRouterStateFromLoaderTreeImpl(parallelRoutes[parallelRouteKey], getDynamicParamFromSegment, searchParams, didFindRootLayout);
...
export async function createFlightRouterStateFromLoaderTree(loaderTree, getDynamicParamFromSegment, searchParams) {
    const didFindRootLayout = false;
    return createFlightRouterStateFromLoaderTreeImpl(loaderTree, getDynamicParamFromSegment, searchParams, didFindRootLayout);
}
export async function createRouteTreePrefetch(loaderTree, getDynamicParamFromSegment) {
