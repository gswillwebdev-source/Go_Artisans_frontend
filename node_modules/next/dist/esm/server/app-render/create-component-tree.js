...
async function createComponentTreeInternal({ loaderTree: tree, parentParams, parentRuntimePrefetchable, rootLayoutIncluded, injectedCSS, injectedJS, injectedFontPreloadTags, ctx, missingSlots, preloadCallbacks, authInterrupts, MetadataOutlet }, isRoot) {
   ...
   */ let MaybeComponent = LayoutOrPage;
    ...
    if (isPage) {
        ...
        if (isClientComponent) {
            ...
            const params = createServerParamsForServerSegment(currentParams, workStore, varyParamsAccumulator, isRuntimePrefetchable);
            // If we are passing searchParams to a server component Page we need to
            // track their usage in case the current render mode tracks dynamic API
            // usage.
            let searchParams = createServerSearchParamsForServerPage(query, workStore, varyParamsAccumulator, isRuntimePrefetchable);
