...
function setupServerHmr(project, { onUpdateFailed }) {
...
export async function createHotReloaderTurbopack(opts, serverFields, distDir, resetFetch, lockfile, experimentalServerFastRefresh) {
    ...
    function clearRequireCache(key, writtenEndpoint, { force } = {}) {
        ...
        for (const file of serverPaths){
            ...
            if (serverHmrSubscriptions == null ? void 0 : serverHmrSubscriptions.has(relativePath)) {
                continue;
            }
        ...
        if (!serverHmrSubscriptions && typeof __next__clear_chunk_cache__ === 'function') {
