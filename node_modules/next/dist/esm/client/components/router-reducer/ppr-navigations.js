...
import { convertReusedFlightRouterStateToRouteTree, readSegmentCacheEntry, waitForSegmentCacheEntry, markRouteEntryAsDynamicRewrite, invalidateRouteCacheEntries, EntryStatus } from '../segment-cache/cache';
import { discoverKnownRoute } from '../segment-cache/optimistic-routes';
import { getRenderedSearchFromVaryPath } from '../segment-cache/vary-path';
import { readFromBFCache, readFromBFCacheDuringRegularNavigation, writeToBFCache, writeHeadToBFCache } from '../segment-cache/bfcache';
...
routeCacheEntry) {
    ...
    if (routeCacheEntry !== null) {
        ...
        if (metadataVaryPath !== null) {
            const now = Date.now();
            discoverKnownRoute(now, retryUrl.pathname, null, seed.routeTree, metadataVaryPath, false, createHrefFromUrl(retryUrl), false, true // hasDynamicRewrite
            );
        }
    }
