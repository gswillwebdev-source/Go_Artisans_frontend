    ...
    return fetchServerAction(state, nextUrl, action).then(async ({ revalidationKind, actionResult, actionFlightData: flightData, actionFlightDataRenderedSearch: flightDataRenderedSearch, redirectLocation, redirectType, isPrerender, couldBeIntercepted })=>{
        ...
        if (flightData !== undefined && flightDataRenderedSearch !== undefined) {
            ...
            if (metadataVaryPath !== null) {
                discoverKnownRoute(now, redirectUrl.pathname, null, redirectSeed.routeTree, metadataVaryPath, couldBeIntercepted, redirectCanonicalUrl, isPrerender, false // hasDynamicRewrite
                );
            }
            return navigateToKnownRoute(now, state, redirectUrl, redirectCanonicalUrl, redirectSeed, currentUrl, currentRenderedSearch, state.cache, currentFlightRouterState, freshnessPolicy, nextUrl, shouldScroll, navigateType, null, // Server action redirects don't use route prediction - we already
        ...
        return navigate(state, redirectUrl, currentUrl, currentRenderedSearch, state.cache, currentFlightRouterState, nextUrl, freshnessPolicy, shouldScroll, navigateType);
    }, (e)=>{
