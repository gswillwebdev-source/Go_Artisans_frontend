...
export function refreshDynamicData(state, freshnessPolicy) {
    ...
    return navigateToKnownRoute(now, state, currentUrl, currentCanonicalUrl, refreshSeed, currentUrl, currentRenderedSearch, state.cache, currentFlightRouterState, freshnessPolicy, nextUrlForRefresh, shouldScroll, navigateType, null, // Refresh navigations don't use route prediction, so there's no route
