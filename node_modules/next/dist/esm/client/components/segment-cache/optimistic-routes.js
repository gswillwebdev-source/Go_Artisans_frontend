 ...
 */ export function discoverKnownRoute(now, pathname, pendingEntry, routeTree, metadataVaryPath, couldBeIntercepted, canonicalUrl, isPPREnabled, hasDynamicRewrite) {
...
now, pathname, fullTree, metadataVaryPath, couldBeIntercepted, canonicalUrl, isPPREnabled, hasDynamicRewrite) {
    ...
    if (segmentAppearsInURL) {
        ...
        if (paramName === null && urlPart !== segment) {
            ...
            return writeRouteIntoCache(now, pathname, fullTree, metadataVaryPath, couldBeIntercepted, canonicalUrl, isPPREnabled);
        }
    ...
    if (existingEntry !== null) {
        ...
        entry = writeRouteIntoCache(now, pathname, fullTree, metadataVaryPath, couldBeIntercepted, canonicalUrl, isPPREnabled);
    }
    if (hasDynamicRewrite) {
