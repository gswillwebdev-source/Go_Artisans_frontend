...
export class TurbopackManifestLoader {
   ...
   */ loadMiddlewareManifest(pageName, type) {
    ...
    writeMiddlewareManifest() {
        let clientMiddlewareManifestPath = this.deploymentId && !this.dev ? join(CLIENT_STATIC_FILES_PATH, TURBOPACK_CLIENT_MIDDLEWARE_MANIFEST) : join(CLIENT_STATIC_FILES_PATH, this.buildId, TURBOPACK_CLIENT_MIDDLEWARE_MANIFEST);
