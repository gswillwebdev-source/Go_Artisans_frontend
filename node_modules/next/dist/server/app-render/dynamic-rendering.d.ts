...
export declare function createInstantValidationState(): InstantValidationState;
...
export declare function trackThrownErrorInNavigation(dynamicValidation: InstantValidationState, error: unknown, componentStack: string): void;
...
export declare function getNavigationDisallowedDynamicReasons(workStore: WorkStore, prelude: PreludeState, dynamicValidation: InstantValidationState, boundaryState: ValidationBoundaryTracking): Array<Error>;
export {};
