...
export declare function createServerSearchParamsForMetadata(underlyingSearchParams: SearchParams, workStore: WorkStore): Promise<SearchParams>;
export declare function createServerSearchParamsForServerPage(underlyingSearchParams: SearchParams, workStore: WorkStore, varyParamsAccumulator: VaryParamsAccumulator | null, isRuntimePrefetchable: boolean): Promise<SearchParams>;
