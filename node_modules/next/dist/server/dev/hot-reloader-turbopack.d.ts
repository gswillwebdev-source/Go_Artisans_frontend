...
export declare function createHotReloaderTurbopack(opts: SetupOpts & {
    isSrcDir: boolean;
}, serverFields: ServerFields, distDir: string, resetFetch: () => void, lockfile: Lockfile | undefined, experimentalServerFastRefresh?: boolean): Promise<NextJsHotReloaderInterface>;
