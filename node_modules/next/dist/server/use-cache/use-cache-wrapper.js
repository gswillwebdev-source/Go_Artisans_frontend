    ...
    if (renderResumeDataCache) {
        ...
        if (cachedResult !== undefined) {
            ...
            if (workUnitStore !== undefined && existingResult !== undefined) {
                if (existingResult.entry.revalidate === 0 || existingResult.entry.expire < _constants.DYNAMIC_EXPIRE) {
                        ...
                        case 'request':
                            {
                                if (process.env.NODE_ENV === 'development') {
                                    ...
                                    if (existingResult.entry.expire < _constants.DYNAMIC_EXPIRE && existingResult.hasExplicitExpire === false) {
                                        throw wrapAsInvalidDynamicUsageError(Object.defineProperty(new Error(nestedCacheShortExpireErrorMessage), "__NEXT_ERROR_CODE", {
                                            value: "E1009",
                                            enumerable: false,
                                            configurable: true
                ...
                if (existingResult.entry.stale < _constants.RUNTIME_PREFETCH_DYNAMIC_STALE) {
                    switch(workUnitStore.type){
                        case 'prerender-runtime':
