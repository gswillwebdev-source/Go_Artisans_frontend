...
async function fetchSegmentOnCacheMiss(route, segmentCacheEntry, routeKey, tree) {
    ...
    try {
        ...
        if (process.env.__NEXT_VARY_PARAMS && varyParams !== null) {
            ...
            const fulfilledVaryPath = (0, _varypath.getFulfilledSegmentVaryPath)(tree.varyPath, varyParams);
            const isRevalidation = false;
...
async function fetchSegmentPrefetchesUsingDynamicRequest(task, route, fetchStrategy, dynamicRequestTree, spawnedEntries) {
    ...
    try {
        ...
        if (fetchStrategy === _types.FetchStrategy.PPRRuntime && !response.headers.get(_approuterheaders.NEXT_IS_PRERENDER_HEADER)) {
