...
function refreshReducer(state, action) {
    ...
    const bypassCacheInvalidation = process.env.__NEXT_EXPOSE_TESTING_API && action.devBypassCacheInvalidation;
...
function refreshDynamicData(state, freshnessPolicy) {
    ...
    return (0, _navigation.navigateToKnownRoute)(now, state, currentUrl, currentCanonicalUrl, refreshSeed, currentUrl, currentRenderedSearch, state.cache, currentFlightRouterState, freshnessPolicy, nextUrlForRefresh, shouldScroll, navigateType, null, // Refresh navigations don't use route prediction, so there's no route
