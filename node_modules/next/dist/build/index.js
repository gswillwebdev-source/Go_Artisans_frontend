...
async function writeClientSsgManifest(prerenderManifest, { buildId, distDir, locales, deploymentId }) {
    ...
    let ssgManifestPath = deploymentId ? _path.default.join(_constants1.CLIENT_STATIC_FILES_PATH, '_ssgManifest.js') : _path.default.join(_constants1.CLIENT_STATIC_FILES_PATH, buildId, '_ssgManifest.js');
    ...
    try {
        ...
        await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            await nextBuildSpan.traceChild('generate-route-types').traceAsyncFn(async ()=>{
                ...
                const routeTypesFilePath = _path.default.join(distDir, 'types', 'route-types.d.ts');
                ...
                const entryFilePath = _path.default.join(dir, config.distDirRoot, 'types', 'routes.d.ts');
                const actualTypesDir = _path.default.join(distDir, 'types');
                await (0, _routetypesutils.writeRouteTypesEntryFile)(entryFilePath, actualTypesDir, {
            ...
            await (0, _builddiagnostics.recordFrameworkVersion)("16.2.0-canary.53");
            ...
            if (middlewareFile) {
                ...
                if (staticInfo.runtime === 'nodejs' || (0, _utils1.isProxyFile)(page)) {
                    ...
                    if (bundler === _bundler.Bundler.Turbopack) {
                        ...
                        let clientMiddlewareManifestPath = config.deploymentId ? _path.default.join(_constants1.CLIENT_STATIC_FILES_PATH, _constants1.TURBOPACK_CLIENT_MIDDLEWARE_MANIFEST) : _path.default.join(_constants1.CLIENT_STATIC_FILES_PATH, buildId, _constants1.TURBOPACK_CLIENT_MIDDLEWARE_MANIFEST);
