        ...
        if (config.output === 'export') {
            ...
            async function handleEdgeFunction(page, isMiddleware = false) {
                ...
                if (isAppPage) {
                    ...
                    const nextDataPath = _path.default.posix.join('/_next/data/', buildId, (0, _normalizepagepath.normalizePagePath)(output.pathname) + '.json');
                    outputs.appPages.push({
                        ...output,
            ...
            if (appPageKeys) {
                for (const page of appPageKeys){
                    ...
                    if ((0, _ismetadataroute.isStaticMetadataFile)(normalizedPage)) {
                        continue;
                    }
