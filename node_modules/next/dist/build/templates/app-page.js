...
async function handler(req, res, ctx) {
   ...
   */ const couldSupportPPR = (0, _ppr.checkIsAppPPREnabled)(nextConfig.experimental.ppr);
    ...
    const isInstantNavigationTest = exposeTestingApi && couldSupportPPR && (req.headers[_approuterheaders.NEXT_INSTANT_PREFETCH_HEADER] === '1' || req.headers[_approuterheaders.RSC_HEADER] === undefined && typeof req.headers.cookie === 'string' && req.headers.cookie.includes(_approuterheaders.NEXT_INSTANT_TEST_COOKIE + '='));
